○ Tools Used
- Canva – for creating visual assets and presentation materials  
- Figma – for layout design  
- GDevelop – for developing the interactive top-down game 
- Visual Studio Code – for coding and project development  
- Pixilart – for designing pixel-based npcs

○ Frameworks/Libraries Used
- None

○ Hosting Platform
- GitHub Pages – for hosting the main website  
- GDevelop – for deploying and running the interactive minigame 

○ Brief Explanation of Design Decisions
- The project was designed as a top-down, pixel-style interactive game to present information about Computer Engineering (CPE) in a more engaging and accessible format.
